...
use WPZylos\Framework\Cli\DevTool\Commands\MakeSettingsCommand;

class MakeSettingsCommandTest extends TestCase
{
    public function testCommandIsInstantiable(): void
    {
        $command = new MakeSettingsCommand();
        $this->assertInstanceOf(MakeSettingsCommand::class, $command);
    }

    public function testCommandName(): void
    {
        $command = new MakeSettingsCommand();
        $this->assertSame('make:settings', $command->getName());
    }
